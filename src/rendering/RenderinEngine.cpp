...
RenderingEngine::RenderingEngine(){ //request opengl version 3.2
...
bool RenderingEngine::ready() const {
    return glew_inited && ogl_version_supported;
}

RenderQueue & RenderingEngine::getRenderQueue(){
    return render_que;
}
